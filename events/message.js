...
module.exports = {
  execute: async (client, message, prefix, db) => {
    ...
    if (data.banned == true && message.author.id !== "326758437642043393" && message.author.id !== "302457454846017546") return message.channel.send(`${message.author.username} you're banned from this bot.`)
