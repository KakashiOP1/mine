...
client.on("message", msg =>{
  let emmbed = new Discord.RichEmbed()
    ...
    .setDescription(`<:Dot:724877738418372648> My Default Prefix is : *\n<:dot:708360553952837665>Do \`*help\` To Get Help Page\n<:Dot:724877738418372648> Do \`*invite\` To invite me to server And gain members\n\n<:Dot:724877738418372648> \`Support\`: **__[Support Server](https://discord.gg/WqZWaVP)__** | **__[Invite The Bot](https://discord.com/oauth2/authorize?client_id=740241899633508352&scope=bot&permissions=8)__**`)
    .setFooter(client.user.username)
  if(msg.content === `<@!${config.botID}>`){
    msg.channel.send(emmbed);
  }
  if(msg.content === `@${config.botName}`){
    msg.channel.send(emmbed);
  }
})
