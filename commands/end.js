...
module.exports = {
  ...
  execute: async(client, message, args, data, db) => {
    ...
    msg.edit(`${user} won this lottery and got ${handler.length * 5} rubys! There were ${handler.length} participants !`)
    
    user.send(`Hello ${user}! You won the lottery! You got ${handler.length * 5} rubys! \nThanks For participating In lottery To buy more Lottery Do \`-ticket\` of 5 rubys`)
