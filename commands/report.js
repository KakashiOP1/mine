...
module.exports = {
  ...
  execute: async(client, message, args, data, db) => {
    ...
    .setDescription(`Try reporting the bug in 2 Minutes ! else this report will get expire ! if your bug is founded good to developer team then you will be rewarded rubys according to bug`)
